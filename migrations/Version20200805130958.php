 ...
 */
final class Version20200805130958 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product CHANGE category_id sub_category_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product CHANGE sub_category_id category_id INT DEFAULT NULL');
